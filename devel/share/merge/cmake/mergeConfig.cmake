...
if("TRUE" STREQUAL "TRUE")
  set(merge_SOURCE_PREFIX /home/h/RC26_Vision_src/src/merge)
  set(merge_DEVEL_PREFIX /home/h/RC26_Vision_src/devel)
  set(merge_INSTALL_PREFIX "")
  set(merge_PREFIX ${merge_DEVEL_PREFIX})
else()
  set(merge_SOURCE_PREFIX "")
  set(merge_DEVEL_PREFIX "")
  set(merge_INSTALL_PREFIX /home/h/RC26_Vision_src/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/h/RC26_Vision_src/src/merge/${idir}'.  ${_report}")
    endif()
